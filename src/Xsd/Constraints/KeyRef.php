...
/**
 * Represents an XSD keyref identity constraint.
 *
...
final class KeyRef
{
    ...
    /**
     * Set the selector for this keyref constraint.
     */
    ...
    /**
     * Add a field to this keyref constraint.
     */
    ...
    /**
     * Set the key this keyref refers to.
     */
    public function refer(string $keyName): self
    {
        $this->refer = $keyName;
