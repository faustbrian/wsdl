...
/**
 * WS-AtomicTransaction policy assertion.
 *
 * Represents a two-phase commit transaction protocol for short-lived,
 * tightly-coupled transactions that require ACID properties.
 *
...
final class AtomicTransaction
{
    ...
    /**
     * Set the WS-AtomicTransaction version.
     *
